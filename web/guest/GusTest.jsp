...
<html>
    ...
    <body>
     ...
     <div class="container">
        ...
        <form action="TestPackage" method="get" class="search-container">
                ...
                <div class="packages-grid">
                    <c:forEach var="test" items="${tests}">
                        <div class="package-card">
                            <h3><a href="packageDetail.jsp?testID=${test.id}">${test.name}</a></h3>
                            <p>${test.description}</p>
                            <div>
                                <span class="price">${test.price}đ</span>
                            </div>
                            <p>Thời gian: ${test.duration_minutes} phút</p>
                            <p>Danh mục: ${test.category}</p>
                            <button onclick="location.href='bookAppointment?testID=${test.id}'">Đặt khám ngay</button>
                        </div>
                    </c:forEach>
                </div>
