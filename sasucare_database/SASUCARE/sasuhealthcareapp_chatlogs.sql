...
CREATE TABLE `chatlogs` (
  ...
  CONSTRAINT `chatlogs_ibfk_1` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`appointment_id`),
  CONSTRAINT `chatlogs_ibfk_2` FOREIGN KEY (`sender_id`) REFERENCES `users` (`user_id`)
