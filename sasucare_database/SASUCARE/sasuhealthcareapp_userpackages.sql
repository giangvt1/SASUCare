...
CREATE TABLE `userpackages` (
  ...
  CONSTRAINT `userpackages_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `userpackages_ibfk_2` FOREIGN KEY (`package_id`) REFERENCES `servicepackages` (`package_id`)
