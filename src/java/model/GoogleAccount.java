...
public class GoogleAccount {
    ...
    public String toString() {
        return "GoogleAccount{" + "account_id=" + id + ", email=" + email + ", name=" + name + ", first_name=" + first_name + ", given_name=" + given_name + ", family_name=" + family_name + ", picture=" + picture + ", verified_email=" + verified_email + '}';
    }
