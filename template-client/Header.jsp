<%-- 
    Document   : Header.jsp
    Created on : 13 thg 1, 2025, 21:29:52
    Author     : TRUNG
--%>
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <button class="nav-item nav-link bg-primary nav-btn btn-register">
                                Register 
                            </button>
                            <button href="#!" class="nav-item nav-link bg-primary nav-btn btn-login">
                                Login
                            </button>
                        </div>
                    </div>
